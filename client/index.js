...
var $author$project$EventParser$Event = F2(
	function (a, b) {
...
var $author$project$EventParser$isValidKeyChar = function (_char) {
...
var $author$project$EventParser$keyParser = $elm$parser$Parser$getChompedString(
	A2(
		$elm$parser$Parser$ignorer,
		$elm$parser$Parser$succeed(_Utils_Tuple0),
		$elm$parser$Parser$chompWhile($author$project$EventParser$isValidKeyChar)));
			...
			[
				...
				A2(
					...
					A2(
						...
						A2(
							$elm$parser$Parser$ignorer,
							A2($elm$parser$Parser$ignorer, $author$project$EventParser$keyParser, $elm$parser$Parser$spaces),
				...
				A2(
					...
					A2(
						$elm$parser$Parser$ignorer,
						$author$project$EventParser$valueParser,
...
var $author$project$EventParser$descriptorsParser = A2($elm$parser$Parser$loop, _List_Nil, $author$project$EventParser$descriptorHelp);
var $author$project$EventParser$idParser = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$ignorer,
		A2(
	...
	A2(
		...
		A2(
			...
			$elm$parser$Parser$symbol(']')),
		$elm$parser$Parser$chompUntilEndOr('\n')));
var $author$project$EventParser$eventParser = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$keeper,
		$elm$parser$Parser$succeed(
			F2(
				function (id, descriptors) {
					return A2($author$project$EventParser$Event, id, descriptors);
				})),
...
var $author$project$Main$calItems = function (descriptors) {
	return A2(
		$elm$core$List$map,
		function (_v0) {
			var x = _v0.a;
			...
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('id: ' + (x + (' value: ' + y)))
					]));
		},
		descriptors);
};
...
var $author$project$Main$parseText = function (s) {
	return $author$project$Main$Hello(s);
};
...
var $author$project$Main$editor = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$classList(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('editor-text-area'),
					$elm$html$Html$Attributes$spellcheck(false),
					$elm$html$Html$Events$onInput($author$project$Main$parseText)
				]),
			_List_Nil)
		]));
...
var $author$project$Main$footer = A2(
	...
	_List_fromArray(
		[
			$elm$html$Html$text('made with <3 by 1ntEgr8')
		]));
